...
Write the H3 prompt itself in English. Preserve Chinese only inside spoken dialogue tags such as <d>[Chinese] 台词</d> and for exact visible text requested by the shot. Keep the prompt between 500 and 3200 characters. Make every detail visible or audible; use precise timing, one coherent primary action, stable identity and wardrobe, concrete camera motion, synchronized diegetic sound, and a clear music decision. Do not invent characters, products, dialogue, claims, reference assets, or on-screen text. Do not output Markdown or commentary. Return JSON only: {{"video_prompt": "..."}}."""
